...
const deliverySchema = z.object({
  ...
  platform: z.enum(["ifood", "other", "takeat"]).optional(),
  platformOrderId: z.string().trim().max(60).optional(),
  pickupCode: z.string().trim().max(40).optional(),
  ifoodLocalizer: z.string().trim().max(40).optional(),
  ifoodConfirmed: z.boolean().optional(),
  ifoodConfirmedAt: z.string().optional(),
